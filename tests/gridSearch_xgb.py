...
#train = load_processed_bosch_data(data_path, data_yaml_file, data_index=data_index, nrows=1000)

const_param_dict = {}
const_param_dict["eta"]                      = 0.001
const_param_dict["subsample"]                = 1.0
const_param_dict["colsample_bytree"]         = 1.0
#const_param_dict["num_round"]                = 5
...
tuning_param_dict = {'num_round' : [1000, 3000, 5000], 'max_depth' : [3, 4, 5, 6, 7]}
