...
tot_bins = [str(x) for x in range(5)]
...
## section to combine all the csv files together
csv_file_path           = './'
submission_sample_file  = 'sample_submission.csv'
submission_sample_path  = '/mnt/home/ymm/bosch'
combine_prediction_results_for_combined_models(csv_file_path, submission_sample_path, submission_sample_file, index_col_name = 'Id', res_col_name = 'Response')
